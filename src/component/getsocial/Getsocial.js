...
const Getsocial = () => {
  return (
    <>
      ...
      <a href="https://www.facebook.com/soham.pabrekar.9" target="_blank">
        <i className="footer-icons fa fa-facebook-official w3-hover-opacity"></i>
      </a>
      <a href="https://www.instagram.com/sohamkpabrekar/" target="_blank">
        <i className="footer-icons fa fa-instagram w3-hover-opacity"></i>
      </a>
      <a href="https://wa.me/919664886201" target="_blank">
